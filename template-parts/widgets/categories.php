...
class WT_Widget_Cozy_Categories extends WP_Widget {
    ...
    public function widget( $args, $instance ) {
        ...
        $title = apply_filters( 'widget_title', empty( $instance['title'] ) ? __( 'Categories', 'cozy' ) : $instance['title'], $instance, $this->id_base );
