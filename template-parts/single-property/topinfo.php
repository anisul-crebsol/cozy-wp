<?php global $wt_cozy; ?>
<?php
    $property_types = wp_get_post_terms(get_the_ID(), 'wt-property-types', array("fields" => "names"));
    $property_id = get_post_meta( get_the_ID(), '_wt_property_id', true);
    $property_address = get_post_meta( get_the_ID(), '_wt_property_address', true);
    $property_city = get_post_meta( get_the_ID(), '_wt_property_city', true);
...
<div class="property-topinfo">
    <ul class="amenities">
        ...
        <?php $terms = wp_get_post_terms(get_the_ID(), 'wt-property-types', array("fields" => "names"));
            $i=0;
