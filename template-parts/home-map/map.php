                    ...
                    <form method="get" action="<?php echo esc_url( home_url( '/' ) ); ?>">
                        <div class="form-group">
                            <div class="form-control-large">
                                ...
                                <input type="text" class="form-control" value="<?php if(isset($_GET['location'])){ echo esc_attr($_GET['location']); } ?>" name="location" placeholder="<?php _e('City, State, Country, etc...', ''); ?>">
                            </div>
                            <?php
