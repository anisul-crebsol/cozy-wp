...
<div id="listing-header" class="clearfix">
    ...
    <div class="form-control-small">
        <select id="sort_by_agency" name="sort_by_agency" data-placeholder="<?php _e('Choose', 'cozy'); ?>">
            ...
            <option label="Select one" value="<?php if (addURLParameter($url, 'sorted_by','city')) : echo addURLParameter($url, 'sorted_by','city'); else: echo addURLParameter($url, 'sorted_by','state'); endif;  ?>&amp;<?php echo addURLParameter($url, 'sorted_by', $sort_by_agency); echo $state_city; ?>"><?php echo $state_city; ?></option>
        <?php }  wp_reset_query(); ?>
        </select>
    </div>
