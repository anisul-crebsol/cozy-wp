	...
	<div class="container">
		...
		<?php if ( have_posts() ) : while ( have_posts() ) : the_post(); ?>
			<div class="col-sm-7">
				...
				<a href="<?php echo get_post_type_archive_link('agent'); ?>" class="btn btn-default-color" data-animation-direction="from-left" data-animation-delay="500"><?php _e( 'Find an Agent', 'cozy' );?></a>
			</div>
