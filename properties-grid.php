						...
						<div class="col-sm-12">
							...
							<nav class="navbar">
								...
								<ul class="nav navbar-nav">
									<li class="dropdown">
										<a href="#" data-toggle="dropdown" data-hover="dropdown">Home<b class="caret"></b></a>
									...
									<li class="dropdown">
										<a class="active" href="#" data-toggle="dropdown" data-hover="dropdown">Properties<b class="caret"></b></a>
										<ul class="dropdown-menu">
											<li><a href="properties-detail.html">Properties Detail</a></li>
											<li><a href="properties-list.html">Properties List</a></li>
											<li><a class="active" href="properties-grid.html">Properties Grid</a></li>
						...
						<div id="property-listing" class="grid-style1 clearfix">
							...
							<div class="row">
								<div class="item col-md-4"><!-- Set width to 4 columns for grid view mode only -->
									...
									<div class="info">
										<h3>
											<a href="properties-detail.html">Luxury Condo with 2 bedroms</a>
											<small>Brooklyn Heights, New York</small>
										</h3>
										<p>Sed rutrum urna id tellus euismod gravida. Praesent placerat, mauris ac pellentesque fringilla, tortor libero condimen.</p>
								...
								<div class="item col-md-4"><!-- Set width to 4 columns for grid view mode only -->
									...
									<div class="info">
										<h3>
											<a href="properties-detail.html">Edition Residences on Collins Avenue</a>
											<small>Miami Beach, Florida</small>
										</h3>
										<p>Sed rutrum urna id tellus euismod gravida. Praesent placerat, mauris ac pellentesque fringilla, tortor libero condimen.</p>
								...
								<div class="item col-md-4"><!-- Set width to 4 columns for grid view mode only -->
									...
									<div class="info">
										<h3>
											<a href="properties-detail.html">Gorgeous Apartment in New York</a>
											<small>SoHo - Nolita, New York</small>
										</h3>
										<p>Sed rutrum urna id tellus euismod gravida. Praesent placerat, mauris ac pellentesque fringilla, tortor libero condimen.</p>
