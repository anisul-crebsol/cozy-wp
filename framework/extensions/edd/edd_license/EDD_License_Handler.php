...
if ( !class_exists( 'EDD_License' ) ) {
	...
	class EDD_License {
		...
		public function activate_license() {
			...
			// Call the API
			$response = wp_remote_get( esc_url(add_query_arg( $api_params, 'https://easydigitaldownloads.com') ), array( 'timeout' => 15, 'body' => $api_params, 'sslverify' => false ) );
		...
		public function deactivate_license() {
			...
			if ( isset( $_POST[$this->item_shortname . '_license_key_deactivate'] ) ) {
				...
				// Call the API
				$response = wp_remote_get( esc_url(add_query_arg( $api_params, 'https://easydigitaldownloads.com' ) ), array( 'timeout' => 15, 'sslverify' => false ) );
