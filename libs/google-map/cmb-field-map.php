...
/**
 * Class WT_Cozy_Field_Google_Maps
 */
class WT_Cozy_Field_Google_Maps {
	...
	public function setup_admin_scripts() {
		...
		wp_enqueue_script( 'pw-google-maps', get_template_directory_uri() . '/libs/google-map/js/script.js', array( 'pw-google-maps-api' ), self::VERSION );
		wp_enqueue_style( 'pw-google-maps', get_template_directory_uri() .  '/libs/google-map/css/style.css', array(), self::VERSION );
	}
}
$WT_Cozy_Field_Google_Maps = new WT_Cozy_Field_Google_Maps();