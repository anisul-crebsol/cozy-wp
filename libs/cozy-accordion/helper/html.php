...
abstract class Html {
	...
	{
		$html = '<a href="#" id="wt-media" class="btn button" data-toggle="modal" data-target="#wt-modal">CozyAccordion</a>';
	...
	public static function getModal()
	{
		...
		$html[] = '<div class="modal fade" id="wt-modal" data-backdrop="static">';
	...
	public static function getModalHeader()
	{
		$html = '<div class="modal-header">
			        ...
			        <h4 class="modal-title" id="wt-modal-label">Cozy Accordion</h4>
			      </div>';
	...
	public static function getPresetStyles(){
		$html = '<select class="pull-right presets uninit" >
					<option value="wt-default" selected >Select Styles</option>
					<optgroup label="Bootstrap Styles">
						<option value="wt-green">Bootstrap Success</option>
					  	<option value="wt-blue">Bootstrap Infro</option>
					  	<option value="wt-yellow" >Bootstrap Warning</option>
					  	<option value="wt-red" >Bootstrap Danger</option>
				  	</optgroup>
				  	<optgroup label="WiselyThemes Styles">
				  		<option value="wt-style1">Style 1</option>
				  		<option value="wt-style2">Style 2</option>
				  	</optgroup>
				</select>';
	...
	{
		$html = '<div id="repeatable" class="panel-group wt-default" role="tablist"><br>
