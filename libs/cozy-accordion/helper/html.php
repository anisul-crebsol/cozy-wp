...
abstract class Html {
	...
	{
		$html = '<a href="#" id="xa-media" class="btn button" data-toggle="modal" data-target="#xa-modal">CozyAccordion</a>';
	...
	public static function getModalHeader()
	{
		$html = '<div class="modal-header">
			        ...
			        <h4 class="modal-title" id="xa-modal-label">Cozy Accordion</h4>
			      </div>';
