...
add_shortcode('wt_acc','accordion_shortcode');
...
function accordion_shortcode_nested($attr, $content= null){
    ...
    <div class="panel-heading" role="tab" id="headingOne">
      <h4 class="panel-title">
        <a class="collapsed" data-toggle="collapse" data-parent="#accordion-'.$item.'" href="#acc-'.$count.'" aria-expanded="true" aria-controls="collapseOne">
...
add_shortcode('wt_slide','accordion_shortcode_nested');
