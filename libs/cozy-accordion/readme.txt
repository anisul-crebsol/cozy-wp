...
[Cozy Accordion](https://www.themexpert.com/wordpress-plugins/xpert-accordion-wp) for is highly customizable shortcode accordion plugin for WordPress.  A user can generate unlimited accordion set anywhere in posts and pages with artistic UI.  Cozy Accordion plugin comes with bundle of opportunity such easy style switching, shorting and many more awesome features. The plugin is build with ThemeXpert's own css prefixes to avoid CSS conflict with plugins.

**[Live Demo](http://demo.themexpert.com/wpplugins/xpert-accordion)**

 **Feature**

* Cozy Accordion is responsive and friendly to any mobile devices
...
[/xa_acc]
`
Though don't need to understand shortcode by yourself, Cozy Accordion will generate for you. If you want update your accordion set manually. it takes three parameters to change accordion title, style and title icons. 
...
**Icon Parameters**
You don't need to touch shortcode parameter for title icons if you select them correctly while creating items. If you want update them. Just add the icon name. Cozy Accordion supports **FontAwesome** icons. FontAwesome come with `fa fa` prefix with each individual icon. Cozy Accordion will add the prefix automatically for you. you need only pass the icon name. Have a look on the examples.
...
02. Activate the Cozy Accordion plugin through the 'Plugins > Installed Plugins' menu in WordPress.

**To create accordion:**

01. Go to Add New Post or Add New Page.
02. Click on CozyAccordion button.
...
2. The model will open up after clicking CozyAccordion button to create accordion items
